...
class MouseMover extends Panner {
    ...
    public void run() {
        ...
        //if (canvas.processPointerEvent((int) (canvas.mouseX + ((double) velocity.x * scale)), (int) (canvas.mouseY + ((double) velocity.y * scale)), MotionEvent.ACTION_MOVE, 0, false, true)) {

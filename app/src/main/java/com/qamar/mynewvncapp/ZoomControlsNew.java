...
public class ZoomControlsNew extends LinearLayout {

    private final ZoomButton mZoomIn;
    private final ZoomButton mZoomOut;
    //private final KeyboardView mKeyboard;

    public ZoomControlsNew(Context context) {
        super(context);
        mZoomOut = null;
        mZoomIn = null;
       // mKeyboard = null;
    ...
    public ZoomControlsNew(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setFocusable(false);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.zoom_controls_new, this, // we are the parent
                true);
